"""
This module contains the MyProjectsPage,
the page object for the my project page.
"""
...
class MyProjectsPage(PageObject):
    URL = "http://0.0.0.0:" + serverInfo.getPort() + "/user-main/my-projects"
    ...
    def setPageObjects(self, pageObjects):
        super(MyProjectsPage, self).setPageObjects(pageObjects)
