...
class SideBarPage(PageObject):
    ...
    def elementsPresent(self, userGroup):
        ...
        self.browser.find_element(*self.RESOURCES_TEXT)
        self.browser.find_element(*self.NEWS)
        self.browser.find_element(*self.DOCUMENTATION)
        self.browser.find_element(*self.FILES)
