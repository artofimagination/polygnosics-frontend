...
! function(t) {
    ...
    function m(i) {
        return this.each(function() {
            var o = t(this),
                s = o.data(e);
            if (!s) {
                var a = t.extend({}, n, o.data(), "object" == typeof i && i);
                o.data(e, s = new p(a))
            }
            if ("string" == typeof i) {
    ...
    p.prototype.activate = function() {
        this.fix(), this.fixSidebar(), t("body").removeClass(f), this.options.resetHeight && t("body, html, " + i).css({
            height: "auto",
            "min-height": "100%"
        }), this.bindedResize || (t(window).resize(function() {
            this.fix(), this.fixSidebar(), t(u + ", " + c).one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
        ...
        t(s + " > " + i).css("overflow", "hidden");
        var e = t(a).outerHeight() || 0,
            n = t(r).outerHeight() + e,
            d = t(window).height(),
            u = t(c).height() || 0;
        if (t("body").hasClass(h)) t(o).css("min-height", d - e);
        else {
            var f;
            d >= u ? (t(o).css("min-height", d - n), f = d - n) : (t(o).css("min-height", u), f = u);
            var p = t(l);
            void 0 !== p && p.height() > f && t(o).css("min-height", p.height())
        }
    }, p.prototype.fixSidebar = function() {
        t("body").hasClass(h) ? this.options.slimscroll && void 0 !== t.fn.slimScroll && (t(c).slimScroll({
            destroy: !0
        }).height("auto"), t(c).slimScroll({
            height: t(window).height() - t(r).height() + "px",
            color: "rgba(0,0,0,0.2)",
            size: "3px"
        })) : void 0 !== t.fn.slimScroll && t(c).slimScroll({
            destroy: !0
        }).height("auto")
    };
    var g = t.fn.layout;
...
function(t) {
    ...
    b.prototype.init = function() {
        (this.options.expandOnHover || t("body").is(c + d)) && (this.expandOnHover(), t("body").addClass(p)), t(s).on(function() {
            t(window).width() <= this.options.collapseScreenSize && t("body").hasClass(h) && this.close()
        ...
        var e = t(window).width(),
            n = !t("body").hasClass(u);
        e <= this.options.collapseScreenSize && (n = t("body").hasClass(h)), n ? this.close() : this.open()
    }, b.prototype.open = function() {
        t(window).width() > this.options.collapseScreenSize ? t("body").removeClass(u).trigger(t.Event(m)) : t("body").addClass(h).trigger(t.Event(m))
    }, b.prototype.close = function() {
        t(window).width() > this.options.collapseScreenSize ? t("body").addClass(u).trigger(t.Event(g)) : t("body").removeClass(h + " " + u).trigger(t.Event(g))
    }, b.prototype.expandOnHover = function() {
        t(o).hover(function() {
            t("body").is(c + i) && t(window).width() > this.options.collapseScreenSize && this.expand()
        }.bind(this), function() {
            t("body").is(l) && this.collapse()
        }.bind(this))
    }, b.prototype.expand = function() {
        setTimeout(function() {
            t("body").removeClass(u).addClass(f)
        }, this.options.expandTransitionDelay)
    }, b.prototype.collapse = function() {
        setTimeout(function() {
            t("body").removeClass(f).addClass(u)
        }, this.options.expandTransitionDelay)
    };
    var y = t.fn.pushMenu;
    t.fn.pushMenu = v, t.fn.pushMenu.Constructor = b, t.fn.pushMenu.noConflict = function() {
        return t.fn.pushMenu = y, this
    }, t(document).on("click", r, function(e) {
        e.preventDefault(), v.call(t(this), "toggle")
    }), t(window).on("load", function() {
        v.call(t(r))
    })
}(jQuery),
function(t) {
    ...
    var e = "Venusxadmin.tree",
        ...
        u = "expanded.tree",
        h = function(e, n) {
            this.element = e, this.options = n, t(this.element).addClass(l), t(i + r, this.element).addClass(c), this._setUpListeners()
        };
    ...
    function f(i) {
        return this.each(function() {
            var o = t(this);
            if (!o.data(e)) {
                var s = t.extend({}, n, o.data(), "object" == typeof i && i);
                o.data(e, new h(o, s))
            }
        })
    }
    h.prototype.toggle = function(t, e) {
        var n = t.next(o),
            s = t.parent(),
            a = s.hasClass(c);
        s.is(i) && (this.options.followLink && "#" != t.attr("href") || e.preventDefault(), a ? this.collapse(n, s) : this.expand(n, s))
        ...
        n.addClass(c), e.slideDown(this.options.animationSpeed, function() {
            t(this.element).trigger(i)
        }.bind(this))
    }, h.prototype.collapse = function(e, n) {
        var o = t.Event(d);
        e.find(s).removeClass(c), n.removeClass(c), e.slideUp(this.options.animationSpeed, function() {
            e.find(s + " > " + i).slideUp(), t(this.element).trigger(o)
        }.bind(this))
...
function(t) {
    "use strict";
    var e = "Venusxadmin.controlsidebar",
        n = {
            slide: !0
        },
        i = ".control-sidebar",
    ...
    function f(i) {
        return this.each(function() {
            ...
            if (!s) {
                var a = t.extend({}, n, o.data(), "object" == typeof i && i);
                o.data(e, s = new h(o, a))
            }
            "string" == typeof i && s.toggle()
        })
    }
    h.prototype.init = function() {
        t(this.element).is(o) || t(this).on("click", this.toggle), this.fix(), t(window).resize(function() {
            this.fix()
        }.bind(this))
    }, h.prototype.toggle = function(e) {
        e && e.preventDefault(), this.fix(), t(i).is(s) || t("body").is(s) ? this.collapse() : this.expand()
    }, h.prototype.expand = function() {
        this.options.slide ? t(i).addClass(l) : t("body").addClass(l), t(this.element).trigger(t.Event(u))
    }, h.prototype.collapse = function() {
        t("body, " + i).removeClass(l), t(this.element).trigger(t.Event(d))
    }, h.prototype.fix = function() {
        t("body").is(c) && this._fixForBoxed(t(a))
...
function(t) {
    ...
    h.prototype.toggle = function() {
        !t(this.element).is(o) ? this.collapse() : this.expand()
    }, h.prototype.expand = function() {
        var e = t.Event(d),
            n = this.options.collapseIcon,
            i = this.options.expandIcon;
        t(this.element).removeClass(c), t(this.element).find(r).find("." + i).removeClass(i).addClass(n), t(this.element).find(s + ", " + a).slideDown(this.options.animationSpeed, function() {
        ...
        var e = t.Event(l),
            n = this.options.collapseIcon,
            i = this.options.expandIcon;
        t(this.element).find(r).find("." + n).removeClass(n).addClass(i), t(this.element).find(s + ", " + a).slideUp(this.options.animationSpeed, function() {
            t(this.element).addClass(c), t(this.element).trigger(e)
        }.bind(this))
...
function(t) {
    ...
    function a(i) {
        return this.each(function() {
            var o = t(this),
                a = o.data(e);
            if (!a) {
                var r = t.extend({}, n, o.data(), "object" == typeof i && i);
                o.data(e, a = new s(o, r))
            }
            if ("string" == typeof a) {
    ...
    s.prototype.toggle = function(t) {
        t.parents(i.li).first().toggleClass(o), t.prop("checked") ? this.check(t) : this.unCheck(t)
...
function(t) {
    ...
    function a(n) {
        return this.each(function() {
            var i = t(this),
                o = i.data(e);
            o || i.data(e, o = new s(i)), "string" == typeof n && o.toggle(i)
        })
    }
    s.prototype.toggle = function(t) {
        t.parents(i).first().toggleClass(o)
    };
    ...
    t.fn.directChat = a, t.fn.directChat.Constructor = s, t.fn.directChat.noConflict = function() {
        ...
        for (var e = t(this)[0], n = e.files.length, i = "", o = 0; o < n; ++o) i += e.files.item(o).name + ", ";
        i = i.substr(0, i.length - 2), t(this).closest(".file-group").find(".file-value").val(i).text(i).focus()
    ...
    }), t("#quickstats1").sparkline([8, 5, 4, 7, 9, 7, 10, 9], {
        type: "bar",
        height: "35",
        barWidth: "4",
        resize: !0,
        barSpacing: "4",
        barColor: "#843cf7"
    }), t("#quickstats2").sparkline([8, 5, 4, 7, 9, 7, 10, 9], {
        type: "bar",
        height: "35",
        barWidth: "4",
        resize: !0,
    ...
    function(t) {
        ...
        var o = {
                ...
                show: function(t, e) {
                    ...
                    var a, r, c, l, d, u = (l = {
                            top: 0,
                            left: 0
                        }, d = (a = n) && a.ownerDocument, r = d.documentElement, void 0 !== a.getBoundingClientRect && (l = a.getBoundingClientRect()), c = function(t) {
                            return null !== (e = t) && e === e.window ? t : 9 === t.nodeType && t.defaultView;
                            var e
                        }(d), {
                            top: l.top + c.pageYOffset - r.clientTop,
                            left: l.left + c.pageXOffset - r.clientLeft
                        }),
                        h = t.pageY - u.top,
                        f = t.pageX - u.left,
                    ...
                    s.className = s.className + " waves-notransition", s.setAttribute("style", i(m)), s.className = s.className.replace("waves-notransition", ""), m["-webkit-transform"] = p, m["-moz-transform"] = p, m["-ms-transform"] = p, m["-o-transform"] = p, m.transform = p, m.opacity = "1", m["-webkit-transition-duration"] = o.duration + "ms", m["-moz-transition-duration"] = o.duration + "ms", m["-o-transition-duration"] = o.duration + "ms", m["transition-duration"] = o.duration + "ms", m["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", m["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", m["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", m["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", s.setAttribute("style", i(m))
                },
                hide: function(t) {
                    s.touchup(t);
                    var e = this,
                ...
                wrapInput: function(t) {
                    for (var e = 0; e < t.length; e++) {
                        ...
                        if ("input" === n.tagName.toLowerCase()) {
                            ...
                            s || (s = ""), o.setAttribute("style", s), n.className = "waves-button-input", n.removeAttribute("style"), i.replaceChild(o, n), o.appendChild(n)
                        }
                    }
                }
            },
        ...
        function a(e) {
            ...
            null !== n && (o.show(e, n), "ontouchstart" in t && (n.addEventListener("touchend", o.hide, !1), n.addEventListener("touchcancel", o.hide, !1)), n.addEventListener("mouseup", o.hide, !1), n.addEventListener("mouseleave", o.hide, !1), n.addEventListener("dragend", o.hide, !1))
        }
        e.displayEffect = function(e) {
            "duration" in (e = e || {}) && (o.duration = e.duration), o.wrapInput(n(".waves-effect")), "ontouchstart" in t && document.body.addEventListener("touchstart", a, !1), document.body.addEventListener("mousedown", a, !1)
        }, e.attach = function(e) {
            "input" === e.tagName.toLowerCase() && (o.wrapInput([e]), e = e.parentNode), "ontouchstart" in t && e.addEventListener("touchstart", a, !1), e.addEventListener("mousedown", a, !1)
